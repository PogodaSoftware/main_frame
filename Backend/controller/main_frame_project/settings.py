...
SECRET_KEY = os.environ.get(
    'DJANGO_SECRET_KEY',
    'django-insecure-5wmlx--977^w7ef*1c)vhqtajrhkmm^1)b@+3-y8!t7v!1n-(q',  # dev-only fallback
)
...
INSTALLED_APPS = [
    'daphne',               # ASGI server — must precede staticfiles to override runserver
    'channels',             # WebSocket support for real-time beauty chat
...
ASGI_APPLICATION = 'main_frame_project.asgi.application'

# In-memory channel layer — single-process dev (runserver). No Redis needed.
# Group broadcast works across all WS connections in the one runserver process.
CHANNEL_LAYERS = {
    'default': {
