...
_BEAUTY_ROUTES = {
    ...
    'beauty_business_apply_schedule',
    'beauty_business_apply_tools',
    'beauty_business_apply_review',
    'beauty_welcome',
    'beauty_forgot',
    'beauty_error',
    'beauty_404',
...
_ROUTE_PATHS = {
    ...
    'beauty_business_apply_schedule': f'{_BEAUTY_BASE}/business/apply/schedule',
    'beauty_business_apply_tools':    f'{_BEAUTY_BASE}/business/apply/tools',
    'beauty_business_apply_review':   f'{_BEAUTY_BASE}/business/apply/review',
    ...
    'beauty_search': f'{_BEAUTY_BASE}/search',
    ...
    'beauty_admin_flags':            f'{_BEAUTY_BASE}/admin/flags',
