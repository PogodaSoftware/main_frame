...
def verify_experience_display_text(page, experience):
    expect(page.locator(experience_tag)).to_contain_text(experience)
...
def verify_education_display_text(page, education):
    expect(page.locator(education_tag)).to_contain_text(education)
...
@then(parsers.parse('it should display the education third paragraph text "{education_paragraph3}"'))
def verify_education_second_paragraph(page, education_paragraph3):
    expect(page.locator(education_paragraph_3)).to_contain_text(education_paragraph3)
